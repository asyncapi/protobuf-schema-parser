...
import { AsyncApiTypeMap } from 'primitive-types';
...
export class GoogleTypes {
  ...
  private static readonly protobuffTimestamp: SpecTypesV2.AsyncAPISchemaDefinition =
    {
      title: 'Timestamp',
      type: 'object',
      properties: {
  ...
  public static readonly WELL_KNOWN_TYPES: AsyncApiTypeMap = {
    'google.protobuf.Duration': {
      ...
      properties: {
        seconds: {
          ...
          default: 0,
          description:
            'Signed seconds of the span of time. Note: these bounds are computed from: 60 sec/min * 60 min/hr * 24 hr/day * 365.25 days/year * 10000 years',
        },
        nanos: {
          type: 'integer',
          minimum: -999999999,
    ...
    'google.protobuf.Timestamp': this.protobuffTimestamp,
  ...
  public static readonly GOOGLE_API_TYPES: AsyncApiTypeMap = {
    ...
    'google.type.PostalAddress': {
      ...
      properties: {
        ...
        region_code: {
          ...
          examples: ['CH'],
          description:
            'CLDR region code of the country/region of the address. This is never inferred and it is up to the user to ensure the value is correct. See http://cldr.unicode.org/ and http://www.unicode.org/cldr/charts/30/supplemental/territory_information.html for details.',
        },
        language_code: {
          type: 'string',
        ...
        address_lines: {
          ...
          description:
            'Unstructured address lines describing the lower levels of an address. Because values in address_lines do not have type information and may sometimes contain multiple values in a single field (e.g. "Austin, TX")',
        },
        recipients: {
          type: 'array',
          items: {
